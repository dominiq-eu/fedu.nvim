-- autogenerated lush spec on Fri Sep 29 18:19:31 2023
-- Run :Lushify
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    lualine_transitional_lualine_b_command_to_lualine_c_filetype_DevIconTs_command { bg = '#6a6a6a', fg = '#2d3539' },
    ...
    lualine_transitional_lualine_a_command_to_lualine_c_filetype_DevIconLua_command { bg = '#6a6a6a', fg = '#ffffff' },
